...
export default function App(props: PrintToolProps = {}) {
  ...
  const actions: ModeActions = {
    ...
    setMtgInputMode: tool.setMtgInputMode,
    setMtgInput: tool.setMtgInput,
    addMtgCustomImages: tool.addMtgCustomImages,
    removeMtgCustomImage: tool.removeMtgCustomImage,
    clearMtgCustomImages: tool.clearMtgCustomImages,
